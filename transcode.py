...
# get params
parser = sgs_arg_parse(description="start DVRs transcode for sideloading")
...
data = stb.sgs_command({"command":"transcode","id":args.dvr_id,"recorded_utc_time":args.rec_tm})
